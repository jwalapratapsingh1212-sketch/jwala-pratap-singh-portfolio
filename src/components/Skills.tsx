...
const fallbackIcons: Record<string, string> = {
  'Data Science': 'DS', 'Data Analysis': 'DA', Statistics: 'Σ', 'Machine Learning': 'ML',
  'Deep Learning': 'DL', 'Natural Language Processing': 'NLP', 'Generative AI': 'AI',
  'Large Language Models': 'LLM', 'AI Agents': 'AG', 'Computer Vision': 'CV',
  'Data Visualization': 'DV', MLOps: 'MO', 'Research & Problem Solving': 'R',
}
